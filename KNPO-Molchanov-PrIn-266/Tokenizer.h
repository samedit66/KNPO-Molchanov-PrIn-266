...
enum class TOKEN_TYPE {
	...
	HEX_NUMBER, ///< Число в шестнадцатеричной форме записи
	OCTAL_NUMBER, ///< Число в восьмеричной форме записи
	BINARY_NUMBER, ///< Число в двоичной форме записи
...
public:
	...
	*/
	...
	Выделяет токены языка псевдо-ассемблера из строки
